...
**El cartucho no es nuestro.** *Konami's Game Master* lo publico **Konami** para MSX en 1986; su
numero de catalogo es **RC-735** y son 16 KB. No es un juego: es un cartucho de trucos que se
enchufa junto a otro. Todos los derechos sobre el cartucho, y sobre los
juegos que nombra, siguen siendo de sus titulares.
...
El fichero `src/gamemaster.asm` es el desensamblado comentado del cartucho. Se publica
...
Si trabajaste en *Konami's Game Master* o tienes derechos sobre el cartucho, y preferirias que este
