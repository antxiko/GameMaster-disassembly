...
**The cartridge is not ours.** *Konami's Game Master* was published by **Konami** for the MSX in 1986;
its catalogue number is **RC-735** and it is 16 KB. All rights over the game
...
The file `src/gamemaster.asm` is the commented disassembly of the cartridge. It is
...
If you worked on *Konami's Game Master* or hold rights over the game, and you would rather this
