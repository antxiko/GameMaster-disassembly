...
_PAREJAS = [("GETTING-STARTED.html", "EMPEZAR.html"),
            ...
            ("THE-SCREENS.html", "LAS-PANTALLAS.html"),
...
PIE = {
    "es": "<em>Konami's Game Master</em> lo publico Konami en 1986; su numero de catalogo es RC-735 y son 16 KB. No es un juego: es un cartucho de trucos que se enchufa junto a otro y le da vidas o le salta de fase. Todos los derechos sobre el cartucho y sobre los juegos que nombra siguen siendo de sus titulares. Este trabajo es de preservacion, estudio y documentacion, y la imagen del cartucho no se distribuye.",
    "en": "<em>Konami's Game Master</em> was published by Konami in 1986; its catalogue number is RC-735 and it is 16 KB. It is not a game: it is a cheat cartridge that plugs in alongside another one and grants it lives or skips its stages. All rights in the cartridge and in the games it names remain with their holders. This is preservation, study and documentation work, and the cartridge image is not distributed.",
}
...
REPO = os.environ.get("GAMEMASTER_REPO",
                      "https://github.com/antxiko/GameMaster-disassembly")
...
def main(docdir, idioma="en"):
    ...
    for fn in sorted(os.listdir(docdir)):
        ...
        titulo = (m.group(1) if m else fn[:-3]) + " — Konami's Game Master (Konami, 1986)"
